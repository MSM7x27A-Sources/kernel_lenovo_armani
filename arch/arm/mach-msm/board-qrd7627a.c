...
#define MSM_RESERVE_MDP_SIZE              0x2D00000
#define MSM_RESERVE_ADSP_SIZE            0x1200000
#define CAMERA_ZSL_SIZE		(SZ_1M * 150)
...
static struct regulator_init_data ncp6335d_init_data = {
	.constraints	= {
		...
		//yangjq, 20121228, Set to Forced PWM mode for armani's GSM ORFS issue
		.initial_mode	= REGULATOR_MODE_FAST,
#elif defined(CONFIG_HW_AUDI)
		//yangjq, 20130113, Set to Forced PWM mode for audi's GSM ORFS issue
		.initial_mode	= REGULATOR_MODE_FAST,
#else
