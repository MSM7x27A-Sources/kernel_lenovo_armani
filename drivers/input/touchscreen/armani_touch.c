...
#if defined(CONFIG_HW_ARMANI)||defined(CONFIG_HW_ANDORRAP)
static unsigned char CTPM_FW_OFILM[]=
{
#include "armani_ofilm_app.i"
};
static unsigned char CTPM_FW_MUDONG[]=
{
#include "armani_mudong_app.i"
};
...
#if defined(CONFIG_HW_AUDI)
static unsigned char CTPM_FW_OFILM[]=
{
#include "audi_ofilm_app.i"
};
static unsigned char CTPM_FW_MUDONG[]=
{
//#include "audi_mudong_app.i"
};

static unsigned char CTPM_FW_TOPTOUCH[]=
{
#include "audi_toptouch_app.i"
};
#endif
...
//	else
//		emi_off();
     //   printk("%s\n",__func__);//add bu liuyh
if(suspend_flag &&release_flag)	 
{
	printk("miss release when suspend,release the remanent point\n");
	ft5x0x_ts_release();
	release_flag = 0;
	suspend_flag = 0;
}
...
{//	int ret;
//	int irq_pin = FT5x06_IRQ;
//	unsigned irq_cfg = 0;

//	ctp_debug_info("==ft5x0x_ts_resume=\n");
//	 irq_cfg = GPIO_CFG(irq_pin, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA);	
